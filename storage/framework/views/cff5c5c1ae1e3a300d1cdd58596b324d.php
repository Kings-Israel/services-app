...
<blockquote><?php echo e(u::trans("scribe::example_request")); ?>:</blockquote>
...
<?php if($endpoint->isGet() || $endpoint->hasResponses()): ?>
    <?php $__currentLoopData = $endpoint->responses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $response): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <blockquote>
            <p><?php echo e(u::trans("scribe::example_response")); ?> (<?php echo e($response->fullDescription()); ?>):</p>
        </blockquote>
...
<code><?php echo u::trans("scribe::example_response.binary"); ?> - <?php echo e(htmlentities(str_replace("<<binary>>", "", $response->content))); ?></code>
<?php elseif($response->status == 204): ?>
<code><?php echo u::trans("scribe::example_response.empty"); ?></code>
<?php else: ?>
...
<span id="execution-results-<?php echo e($endpoint->endpointId()); ?>" hidden>
    ...
    <pre class="json"><code id="execution-response-content-<?php echo e($endpoint->endpointId()); ?>"
      data-empty-response-text="<<?php echo e(u::trans("scribe::example_response.empty")); ?>>" style="max-height: 400px;"></code></pre>
</span>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\projects\laravel\services-app\vendor\knuckleswtf\scribe\src/../resources/views//themes/default/endpoint.blade.php ENDPATH**/ ?>